...
namespace SetsunaTsuyuri
{
    ...
    public static class IEnumerableExtensions
    {
        ...
        public static void IncrementIndexLoop<T>(this IEnumerable<T> collection, ref int index)
        {
            index++;
        ...
        /// <param name="collection">コレクション</param>
        /// <param name="index">索引</param>
        public static void DecrementIndexLoop<T>(this IEnumerable<T> collection, ref int index)
        {
            index--;
            if (index < 0)
            {
